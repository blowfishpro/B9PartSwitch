...
{
    public class NodeObjectWrapperIConfigNodeTest
    {
        private readonly NodeObjectWrapperIConfigNode wrapper = new NodeObjectWrapperIConfigNode(typeof(DummyIConfigNode));
        #region Constructor
        ...
        public void TestConstructor__NullType()
        {
            ...
            {
                new NodeObjectWrapperIConfigNode(null);
            });
        ...
        public void TestConstructor__NotIConfigNode()
        {
            ...
            {
                new NodeObjectWrapperIConfigNode(typeof(string));
            });

            Assert.Contains("Type System.String does not implement IConfigNode", ex.Message);
            Assert.Equal("type", ex.ParamName);
        }
        ...
        public void TestLoad__BadType()
        {
            ...
            Assert.Contains("Expected parameter of type IConfigNode but got System.String", ex.Message);
